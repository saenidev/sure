...
class LoanTest < ActiveSupport::TestCase
  ...
  # Rate type and term are deliberately not validated here: providers write
  # their own rate vocabulary ("arm") and term through, and the amortisation
  # engine answers those tolerantly (see the rate type tests below).
  test "rejects negative financial amounts" do
    loan = Loan.new(
      initial_balance: -1,
      interest_rate: -0.1
    )
