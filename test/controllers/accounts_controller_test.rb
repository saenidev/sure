...
class AccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "shares account per_page preference with the global transactions page" do
    ...
    # A filterless visit renders page 1 in place (never redirected to stored
    # pagination, see TransactionsController#should_restore_params?), but still
    # uses the page size chosen on the account page.
