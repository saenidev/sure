  ...
  class InputBuilder
    ...
    def call
      ...
      Result.new(
        ...
        accounts: accounts,
        budgets: Forecast::BudgetInputBuilder.new(family: family, user: user, periods: period_result.months, money_converter: converter, scenario_ids: stack.scenario_ids, included_account_scope: included_scope, start_on: start_on).call,
        ...
        portfolio: Forecast::PortfolioSnapshotBuilder.new(family: family, user: user, money_converter: converter, run_date: start_on).call,
